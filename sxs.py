...
bot = telebot.TeleBot('6633486831:AAGHEXxJAVJ0myHGt_cVt0Ycl__mBo-UsWw')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ONLY @PANIC_LAG CAN USE."
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = " ❌ Access expired or unauthorized buy - @Ravan_421"
